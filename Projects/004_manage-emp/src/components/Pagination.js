...
const Pagination = ({pages, setCurrentPage, employeeTotal, currentEmployees}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentEmployees.length}</b> out of <b>{employeeTotal.length}</b> entries</div>
